    ...
    async fetchApi()
    {
        ...
        .then((response)=>
        {
            ...
            if(onlyFav)
            {
                ...
                this.movies=response.data=this.loadOnlyFavMovies()
            }
    ...
    loadOnlyFavMovies()
    {
        ...
        { console.log("ok")
            for (var k in this.movies)
            {
                ...
                if (this.favorites[i].MOVIEID==this.movies[k]._id)
                {
                   
                    onlyFavMovieList[favIndex]=this.movies[k]
                    favIndex++
                }
            }
        }
        return onlyFavMovieList
    },
