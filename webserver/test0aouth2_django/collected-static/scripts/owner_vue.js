...
methods: {
    ...
    async getData()
    {
        ...
        for (var k in this.cinemas)
        {
        await axios.get('http://172.18.1.8:7000/movie?searchCinema='+this.cinemas[k].NAME)
        .then((response)=>
        {
    ...
    async addMovieFunction()
    {
        ...
        await axios.post('http://172.18.1.8:7000/movie',body)
        .then((response)=>
        {
        ...
        if (added)
        {
                body={
                    ...
                    "cinema":{
                        "value":this.cinemaname,
                        "type":"String"

                    }
                }
                await axios.post('http://172.18.1.13:3005/v2/entities/',body)
                .then((response)=>
                {
                    this.addMovie=false
                    this.title=''
