             ...
             async remove()
              {
                  ...
                  await axios.delete('http://172.18.1.13:3005//v2/entities/'+this.id)
                  .then((response)=>
                  {
                        console.log("Delete from ORION ok")
                        this.hide=true
                  }
                  ).catch((error) => 
                  {
                  ...
                  //Delete Possible subs to this movie
                  await axios.delete('http://172.18.1.8:7000/checksubdelete/'+this.id)
                  .then((response)=>
                  {
                        return true
                  }
              ...
              {   
                  ...
                  body={
                        "start_date": {
                        "value": this.startDateEdit,
                        "type": "Date"
                        },
                        "end_date": {
                        "value": this.endDateEdit,
                        "type": "Date"
                        },
                        "cinema":{
                        "value": this.cinemaEdit,
                        "type":"String" 
                        },
                        "movie_name":{
                        "value": this.titleEdit,
                        "type":"String" 
                        }

                }
                await axios.post('http://172.18.1.13:3005/v2/entities/'+this.id+'/attrs',body)
                .then((response)=>
                {
                        console.log("Update entity OK")
                }
                ).catch((error) => 
                {
